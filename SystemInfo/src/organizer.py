...
def organize_folder(target_path: str) -> dict:
    ...
    Returns: Dictionary containing counts of moved files per category.
    """
    summary = {}
    ...
    for filename in os.listdir(target_path):
        ...
        # Handle duplicate filenames (SRS B3: e.g., report_2.pdf)
        ...
        # Move file safely (never deletes)
        try:
...
def start():
    ...
    Integrates cleanly with the professional main menu flow.
    """
    ...
    # Professional summary output (aligned columns, clean separators)
